...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Permissionitems = [
            ...
            [
                'name'        => 'Can Delete Colors',
                'slug'        => 'delete.colors',
                'description' => 'Can delete colors',
                'model'       => 'Permission',
            ],
            [
                'name'        => 'Can View Deleted Colors',
                'slug'        => 'view.deleted.colors',
                'description' => 'Can view deleted colors',
                'model'       => 'Permission',
            ],
            [
                'name'        => 'Can Restore Deleted Colors',
                'slug'        => 'restore.deleted.colors',
                'description' => 'Can restore deleted colors',
                'model'       => 'Permission',
            ],
            [
                'name'        => 'Can Delete Colors Forever',
                'slug'        => 'delete.forever.colors',
                'description' => 'Can delete colors Forever',
                'model'       => 'Permission',
            ],
